...
Perhaps surprising: contribution of bilateral negotiations ($\Rightarrow$ MFN) before 1946 was about half of total from 1930 to Geneva
...
### Decrease in Specific Tariffs by Round
...
### Decrease in Ad Valorem Tariffs by Round
```{r table_2}
...
-  Only 98 lines transition type at any point. 37 specific $\Rightarrow$ *ad valorem*, 24 *ad valorem* $\Rightarrow$ specific
