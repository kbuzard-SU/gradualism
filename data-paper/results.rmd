...
sss_nc <- kbl(sum_specific_nC_pc,digits=2,booktabs=T) %>%
  kable_styling(position = "center", latex_options = "hold_position")
add_header_above(sss_nc, c("Specific Tariffs, switchers removed"=9),font_size = 12)
...
ssav_nC <- kbl(sum_av_nC_pc,digits=2,booktabs=T) %>%
  kable_styling(position = "center", latex_options = "hold_position")
add_header_above(ssav_nC, c("Ad valorem Tariffs, switchers removed"=9),font_size = 12)
