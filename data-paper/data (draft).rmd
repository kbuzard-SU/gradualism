...
Some other issues arose during the digitization process, including dealing with tax intervals, more specified product description and staging process for certain products (that products facing tax reduction through multiple stages), since these issues are mostly related to the robustness and completeness check of our data and relatively trivial, we include the detailed explanation and examples in the data appendix section. Also in order to compare the tax reduction statistically, we unified all of our units to "cents" level and construct a unit key sheet which demonstrates the unique code we have for every type of the unit we have and its original notation before the unit normalization process ^[More details can be found in description in our data set].  
