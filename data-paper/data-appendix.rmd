...
## Smoot-Hawley Industrial Classification System: Schedule
...
## TSUSA Industrial Classification System: Section
...
Here we discuss several issues we encountered while coding the data.

**Tariff intervals**: When, in addition to the usual ad valorem or specific tariff, a line also has a minimum or maximum tariff, we classify the line as being of the"tariff interval" type. For example Paragraph 210 *Rockingham earthenware* in the Geneva 1947 schedule has its rate description as *"20 cents per doz. articles, but not less 7.5% nor more than 25%."*
