...
data_set <- read.csv(file='test_final.csv', encoding="UTF-8",na.string=c(""," ","" ,"" ,"NA"))[,c('X.U.FEFF.Schedule','Paragraph','Description','Specific_SH','Units_SH','Ad_Valorem_SH','Specific_Geneva',
                                                                                                  'Units_Geneva','Ad_Valorem_Geneva','Specific_Annecy','Units_Annecy','Ad_Valorem_Annecy','Specific_Torquay',
                                                                                                  'Units_Torquay','Ad_Valorem_Torquay','Specific_Geneva56_A','Units_Geneva56_A','Ad_Valorem_Geneva56_A',
                                                                                                  'Specific_Geneva56_B','Units_Geneva56_B','Ad_Valorem_Geneva56_B','Specific_Geneva56_C','Units_Geneva56_C',
...
data_set<-data_set %>%
  group_by(Paragraph) %>%
  mutate(Product=row_number())# Now every line can be located as, "Paragraph. X, No. Y product", while the schedule information is contained in the paragraph number. 
