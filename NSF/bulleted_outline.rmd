...
The purpose of the specific aims is to test the parts of your central hypothesis. Your aims must grow out of, and be completely concordant with, the parts of your central hypothesis.

A secondary purpose of the aims is to provide research focus. That is accomplished by including a working hypothesis under each aim. 

- Should we list creating the data as a separate aim?

  - If you are proposing research that is purely need driven, write a bullet that summarizes the main approaches/methods that will be employed to complete the stated task.

- Create (political) theory for why liberalization was gradual; make recommendations for cooperation in other policy areas

  - Write a bullet here that summarizes the working hypothesis for this aim. 
