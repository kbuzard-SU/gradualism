...
1. Can we add TOT analysis? Talk to Ross. If not, some other analysis?
    - *Kristy meets with Ross on 3/3/21*
...
6. Resolve "complicated" paragraphs, including 9 that still have no tariffs
...
6. **Make list of accuracy checks, run them, fix typos in data**
    ...
    - **30-40 more lines have both specific and ad valorem than they did previously. Why?**

7. Figure out how to integrate "free" list
    - **For which rounds do we have the free list typed up? Where are they?**
