...
print.data.frame(neither[which(neither$neitherSH==TRUE),c("X.U.FEFF.Schedule","Product","Paragraph","Description")],row.names = FALSE)

print.data.frame(neither[which(neither$neitherAnnecy==TRUE),c("X.U.FEFF.Schedule","Product","Paragraph","Description")],row.names = FALSE)

print.data.frame(neither[which(neither$neitherDillonB==TRUE),c("X.U.FEFF.Schedule","Product","Paragraph","Description")],row.names = FALSE)
```
