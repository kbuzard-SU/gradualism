...
sm_g2 <- subset(sm_g,is.na(sp_pc) | sp_pc==0) %>% subset(is.na(av_pc) | av_pc==0)
```

The code above produces `r nrow(sm_g2)` lines that are the same in Smoot Hawley and Geneva.
