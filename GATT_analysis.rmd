...
changes <- change_BG %>% full_join(change_G,  by = mergeCols) %>%
                        full_join(change_A,  by = mergeCols) %>%
  full_join(change_T,  by = mergeCols) %>% 
  full_join(change_GA,  by = mergeCols) %>%
  full_join(change_GB,  by = mergeCols) %>% 
  full_join(change_GC,  by = mergeCols) %>%
  full_join(change_DA,  by = mergeCols) %>%
