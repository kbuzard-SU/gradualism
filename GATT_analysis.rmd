...
# Next steps
1. Program stats into abstract (after making Github version for CEA abstract)
2. Can we add TOT analysis? Talk to Ross. If not, some other analysis?
...
11. Consolidate various notes in Github / One Drive / G drive -- create centralized documentation
...
2. Make list of accuracy checks, run them, fix typos in data
...
2. Condense data cleaning code
16. Figure out how to source multiple code files
...
13. Contact the two people Bob Staiger suggested
...
# both this source statement and the following "code" command work to include the data,
#but I haven't yet figured out how to also include UnitsKeys.rmd below,
#so I'm leaving them both here as future debugging options
source("C:/Users/krist/Github/Gradualism/data_cleaning.rmd", local = knitr::knit_global())

#```{r cleandata, code=readLines('C:/Users/krist/Github/Gradualism/data_cleaning.rmd'),eval=TRUE,message=FALSE,warning=FALSE}
#```
...
```{r unitskey, message=FALSE, warning=FALSE, echo=FALSE}
#source("C:/Users/krist/Github/Gradualism/UnitsKey.r", local = knitr::knit_global())
#```{r unitskey, code= readLines('C:/Users/krist/Github/Gradualism/UnitsKey.r'),eval=TRUE}
#```
```
