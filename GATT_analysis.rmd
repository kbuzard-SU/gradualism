...
6. Add Schedule A tariff data from 1946 (last available before Geneva 1947)
...
1. ~~Program stats into abstract~~
2. ~~Resolve copyright issues, then (hopefully) post the correct schedules on Github~~
3. ~~Determine that TSUS tariffs were always at 5 digit, so we can just use the 5-digit tariff for all of the 7-digit subcategories~~
10. ~~Read and summarize "Two Centuries of Tariffs" (USITC, in G:drive folder)~~
11. ~~Consolidate various notes in Github / One Drive / G drive~~
