...
a<-c('Cents per pound','Cents per gallon','Cents per ounce','Cents per square foot','Cents per ton',
     ...
     'Cents per average number of pounds', 'Cents per square yards','Cents per pack', 'Cents per 144 boxes','Cents per 288 inches',
...
b<-c('Units: =1','Units: =2','Units: =4','Units: =6','Units: =7','Units: =10','Units: =18','Units: =19',
     ...
     'Units: =35', 'Units: =36','Units: =37','Units: =41', 'Units: =42','Units: =44','Units: =46','Units: =49', 'Units: =52',
