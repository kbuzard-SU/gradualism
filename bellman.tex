...
\end{center}
\begin{flushleft}
Change$\left[(1-\delta)A(m^\ast_t)\cdot F^\alpha \cdot P^W\right]^\frac{1-\alpha}{\alpha}$\ \text{to}\ $\left[(1-\delta)^\frac{1-\alpha}{\alpha}\cdot A(m^\ast_t)^\frac{1-\alpha}{\alpha}\cdot F^{1-\alpha}\cdot P^{\frac{W-W\alpha}{\alpha}}\right]$
\end{flushleft}
\begin{center}
$\frac{\partial A(m^\ast_t)}{\partial m^\ast_t} \cdot F \cdot P^{\frac{W}{\alpha}}\cdot(1-\delta)^\frac{1-\alpha}{\alpha}\cdot A(m^\ast_t)^\frac{1-\alpha}{\alpha}=\delta$\\
$\frac{\partial A(m^\ast_t)}{\partial m^\ast_t} \cdot A(m^\ast_t)^\frac{1-\alpha}{\alpha}=\frac{\delta}{(1-\delta)^{\frac{1-\alpha}{\alpha}}\cdot F\cdot P^{\frac{W}{\alpha}}}$
\end{center}
\[
t=\text{this period}
\]
