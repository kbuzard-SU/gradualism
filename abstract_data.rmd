...
Things look a bit different for specific tariffs. The mean specific tariff binding decreases from `r round(specific_mean[3,],2)` cents in 1930 to 24 cents in 1964, while the median bindings are much smaller, dropping from 4.375 cents to 3 cents. Specific tariffs are present for roughly half of tariff lines. About 450 lines have both an ad valorem and specific tariff in a given round.
